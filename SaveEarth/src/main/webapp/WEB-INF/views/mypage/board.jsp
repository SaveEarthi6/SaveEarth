...
<div>
	...
	<c:if test="${paging.curPage ne 1 }">
		<li class="page-item"><a href="./board" class="page-link">&laquo;</a></li>	
	</c:if>
	<c:if test="${paging.curPage eq 1 }">
		<li class="page-item disabled"><a href="./board" class="page-link">&laquo;</a></li>	
	</c:if>
	...
	<c:if test="${paging.curPage ne paging.totalPage }">
		<li class="page-item"><a href="./board?curPage=${paging.totalPage }" class="page-link">&raquo;</a></li>	
	</c:if>
	<c:if test="${paging.curPage eq paging.totalPage }">
		<li class="page-item disabled"><a href="./board?curPage=${paging.totalPage }" class="page-link">&raquo;</a></li>	
	</c:if>
