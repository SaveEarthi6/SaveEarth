...
<a href="./campaign"><button type="button" class="btn btn-success" id ="top">캠페인 게시판</button></a>
</div> 
<br>
...
<table id= "board" class= "table table-hover text-center">
   <tr style= "background-color: #59A8D9; color: white;">
      ...
      <th style="width: 20px;">캠페인 상태</th>
      <th style="width: 30px; text-align:center">캠페인 제목</th>
      <th style="width: 20px;">작성일</th>
      <th style="width: 20px;">게시글 삭제</th>
   </tr>
